...
int main(int argc, char*argv[]){
    if(argc < 1) {
        ...
        printf("--(Info) Vermessung 0 0 BleAndWlan\tor\n");
        printf("--(Info) Navigation Bluetooth\t\tor\n");
        printf("--(Info) Navigation Wlan\t\tor\n");
        printf("--(Info) Navigation BleAndWlan\t\tor\n");
        return 0;
    }
    int skfd =0;
    int timer;
    ...
    if (strcmp(argv[1], "Vermessung") == 0) {
        ...
        openFile("../exports/database_final.txt","r+");
        printf("Open File\n\n");
